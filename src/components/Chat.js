...
const Chat = () => {
  ...
  useEffect(() => {
    // Do something when chats change
    console.log("Chats changed:", chats);
  }, [chats]);
  useEffect(() => {
    setCurrentMember(isAdministrator ? "admin_id" : "emp_id");
  }, []);
            ...
            <div className='myComponent' style={mainStyle}>
              <div className='Chat'>
                <div className='Left-side-chat'>
                  ...
                  <SearchChat handleSetCurrentChat={handleSetCurrentChat} empId={currentMember}/>
