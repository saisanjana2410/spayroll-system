...
const AttendanceManagement = () => {
    ...
    let enterData = async () => {
        try {
            const response=await fetch("http://localhost:5000/api/log-attendance/addAttendanceLog", {
                method: "POST",
                headers: {
    ...
    const updateAttendanceLog = async (logId) => {
        try {
            const response = await fetch(`http://localhost:5000/api/log-attendance/updateAttendanceLogs/${logId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    "emp_id":localStorage.getItem("emp_id"),
    ...
    const fetchAttendanceData = async (month) => {
        ...
        setMonth(month);
        try {
            const response = await fetch("http://localhost:5000/api/log-attendance/getAttendanceLogs", {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    "emp_id":localStorage.getItem("emp_id"),
