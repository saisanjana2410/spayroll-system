...
const Profile = () => {
    ...
    let fetchData = async () => {
        try {
          const response = await fetch(
            "http://localhost:5000/api/profile-data/getUser",{
                method: "GET",
                headers: {
                    "emp_id": currentUser,
                }
    ...
    const updateLeftSection = async () => {
        try {
            await axios.put(`http://localhost:5000/api/profile-data/updateLeftSection`, editedEmployee, {
                headers: { 
                    'emp_id': currentUser,
    ...
    const updateRightSection = async () => {
        ...
        try {
            await axios.put(`http://localhost:5000/api/profile-data/updateRightSection`, rest, {
                headers: { 
                    'emp_id': currentUser,
                    'object_id':editedEmployee._id
                }
    ...
    const updateRoleDetails = async () => {
        const { ['image']: removedField, ...rest } = editedEmployee;
        try {
            await axios.put(`http://localhost:5000/api/profile-data/updateRoleDetails`, rest, {
                headers: { 
                    'emp_id': currentUser,
                    'object_id':editedEmployee._id
                }
